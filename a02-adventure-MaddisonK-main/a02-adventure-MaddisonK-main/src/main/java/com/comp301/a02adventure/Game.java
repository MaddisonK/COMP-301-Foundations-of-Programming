...
public interface Game {
   ...
   *
   * <p>First, print "Name: " followed by the Cell's name. For example, if the Cell is named "Polk
   * Place", then this should print: "Name: Polk Place"
   *
   ...
   *
   * <p>Next, if there is a chest in this Cell, print the following text on the following lines:
   * "You found a chest!\nType 'open' to see what's inside, or keep moving."
   *
   ...
   * following String on its own line: "You can't go that way! Try another direction."
   */
