...
//    getCell(5, 9)
//        .setDescription(
//            "Near the highway is the only proper Chick-Fil-A in town. This area is also home to
// a\n"
//                + "drive-in movie theater and Queen of Pho, if you're looking for some quality
// Vietnamese food.");
//
//    initCell(5, 8);
...
//    getCell(5, 7)
//        .setDescription(
//            "Heading north out of Chapel Hill, Columbia St turns sharply downhill. At the
// bottom\n"
//                + "is a gas station, Hunam for Chinese food, and Lucha Tigre Latin-Asian
// fusion.\n"
...
//    getCell(3, 6)
//        .setDescription(
//            "You're at the edge of Rosemary Street! Directly to the north of Franklin, this
// east-west\n"
//                + "directional street has neat establishments like Pantina Bob's and La
// Residence.\n"
...
//    getCell(7, 6)
//        .setDescription(
//            "Two of the coolest eateries in Chapel Hill can be found on this small road off of
// Franklin St.\n"
//                + "TRU Deli lets you build and order your own sandwiches using your phone, and "
//                + "Imbibe/Zog's\nhas the best Cajun food around.\nGo south to return to Franklin
// Street.");
//
//    initCell(0, 5);
...
//    getCell(0, 5)
//        .setDescription(
//            "You're at the west edge of Carrboro. Head back east to see what Chapel Hill has to
// offer!");
//
//    initCell(1, 5);
...
//    getCell(1, 5)
//        .setDescription(
//            "This is the center of Carrboro! Visit Amante for some affordable and delicious
// pizza,\n"
...
//    getCell(2, 5)
//        .setDescription(
//            "You're at the east edge of Carrboro. There are some cool restaurants here, like Al's
// Burger Shack\n"
...
//    getCell(3, 5)
//        .setDescription(
//            "Need some groceries? There's a Target to the south. You could head east to go
// downtown,\n"
//                + "north to check out Rosemary Street, or west to see the quaint town of
// Carrboro.\n"
...
//                + "There's a small yogurt shop and a Ben & Jerry's for your dessert needs, a
// local\n"
//                + "favorite bar called He's Not Here, a Vietnamese Pho restaurant, and a sushi
// restaurant.");
//
//    initCell(5, 5);
...
//    getCell(6, 5)
//        .setDescription(
//            "This is the most iconic strip of Franklin St, full of shops, restaurants, bars, and
// clubs.\n"
//                + "A few highlights: Hibachi & Co, Sutton's Drugstore, Epilogue Books, the Varsity
// Theater,\n"
...
//    getCell(7, 5)
//        .setDescription(
//            "On the east side of Chapel Hill's historic downtown district is a large, old post
// office.\n"
...
//    getCell(3, 4)
//        .setDescription(
//            "This small, floor-plan neighborhood Target has the groceries and items you need for
// your dorm life.");
//
//    initCell(4, 4);
...
//    getCell(4, 4)
//        .setDescription(
//            "The small ring of fraternity houses here always smells a bit funny, but it
// provides\n"
...
//    getCell(5, 4)
//        .setDescription(
//            "You see an art museum with a few select exhibits on display outside. To the west
// is\n"
//                + "Fraternity Court; Franklin St is northwards, and the UNC campus is just to the
// south.");
//
//    initCell(6, 4);
...
//    getCell(8, 4)
//        .setDescription(
//            "A massive sundial marks the entrance to Morehead Planetarium, on the east side of
// Chapel Hill.");
//
//    initCell(9, 4);
...
//    getCell(9, 4)
//        .setDescription(
//            "One of the most beautiful places on campus, the arboretum consists of a wide
// variety\n"
//                + "of plantings including flowering trees and shrubs as well as bulb and perennial
// displays.");
//
//    initCell(5, 3);
...
//    getCell(5, 3)
//        .setDescription(
//            "You found the Computer Science building! Normally, you can find students in here
// working on\n"
//                + "independent projects, checking out organization booths, or finding help in
// office hours.");
//
//    initCell(6, 3);
...
//    getCell(6, 3)
//        .setDescription(
//            "Right along the road is Memorial Hall. This grand performance space hosts several
// events a year,\n"
...
//    getCell(8, 3)
//        .setDescription(
//            "Lenoir is the dining hall on North Campus. The bottom floor has food-court style
// vendors,\n"
...
//    getCell(9, 3)
//        .setDescription(
//            "This library contains several floors of study rooms, dusty bookshelves, and napping
// spots.");
//
//    initCell(5, 2);
...
//    getCell(5, 2)
//        .setDescription(
//            "Home to the Friends Cafe and countless STEM resources. If you're also a Health
// Science student,\n"
//                + "check out the Blue Room on the second floor; it's open 24/7 and perfect for
// studying.");
//
//    initCell(6, 2);
...
//                + "in stark contrast to its parents, Wilson and Davis. Even though it's
// smaller,\n"
//                + "it hosts a broad collection of DVDs you can borrow, down in the Media & Design
// Center.");
//
//    initCell(8, 2);
...
//    getCell(8, 1)
//        .setDescription(
//            "Need textbooks and scantrons? What about coffee, or a quick bite to eat? The Student
// Bookstore\n"
//                + "has all those things, including a neat escalator that takes you from the Pit to
// South Road.");
//
//    initCell(8, 0);
...
//    getCell(8, 0)
//        .setDescription(
//            "Right across from the Student Bookstore, the Bell Tower is one of UNC's well-known
// landmarks.\n"
//                + "Feel free to guess what's up at the top of the tower, because I don't know
// either.");
//
//    // ********************************************************************************
//    // SET TREASURE CHESTS
